...
public class Doc : StupidMonster
{
    ...
    public override int Score => 55;

    public Doc(Vector2 positionInWorld, List<Tuple<Point, int>> pathInWorldPoints, int heartsCount = 3,
        float speed = 1) : base(positionInWorld, pathInWorldPoints, speed)
    {
        ...
        var texture = Globals.Content.Load<Texture2D>("./Levels/assets/Doc");
